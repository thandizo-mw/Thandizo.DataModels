...
namespace Thandizo.DataModels.DataCenters
{
    ...
    {
        [Required(ErrorMessage = "Facility Resource Id cannot be blank")]
        [Range(1, int.MaxValue, ErrorMessage = "Please enter valid integer number for Facility Resource Id")]
